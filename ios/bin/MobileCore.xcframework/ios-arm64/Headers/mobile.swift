...
open func add(x: Int32) {try! rustCall() {
...
private var initializationResult: InitializationResult = {
    ...
    if (uniffi_mobile_checksum_method_calculator_add() != 22197) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_mobile_checksum_method_calculator_get_value() != 57532) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_mobile_checksum_constructor_calculator_new() != 51082) {
        return InitializationResult.apiChecksumMismatch
    }
